...
- **Retention ≈ 3 years** — the German civil limitation period (§§ 195, 199 BGB)
  ...
  the window expires, *delete* — keeping it longer violates data minimisation
  (Art. 5(1)(e) DSGVO). Use `server/scripts/prune.sh` (default
  `RETENTION_DAYS=1095`) from cron to do this automatically.
